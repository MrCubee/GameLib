 ...
 */
public class KitAddPlayerEvent<P extends GameJavaPlugin<P, S, G>, S extends GameSettings, G extends Game<P, S, G>> extends KitPlayerEvent<P, S, G> implements Cancellable {
