 ...
 */
public class GameEndEvent<P extends GameJavaPlugin<P, S, G>, S extends GameSettings, G extends Game<P, S, G>> extends GameEvent<P, S, G> {

    private static final HandlerList HANDLERS = new HandlerList();

    public GameEndEvent(final G game) {
        super(game);
    }
